...
export default function Hero(){
  ...
  <section className="relative pt-12 luxury-gradient overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 py-20 grid md:grid-cols-2 gap-8 items-center">
        <motion.div initial={{opacity:0,y:20}} animate={{opacity:1,y:0}} transition={{delay:0.1}} className="">
        ...
        <motion.div initial={{opacity:0, scale:0.98}} animate={{opacity:1, scale:1}} transition={{delay:0.15}} className="rounded-lg overflow-hidden shadow-2xl">
          <Slideshow />
        </motion.div>
      </div>
    </section>
